...
public class RegisterParkingActivity extends AppCompatActivity {
    ...
    private TextView text_facilityId;

    private TextView text_carParking_address;

    private ImageButton btn_location;

    private EditText et_facilityID;

    private EditText et_carParking_address;

    private EditText et_carParking_detail_address;

    private Button btn_saveCarParking;
  ...
  /*  private TextView txt_lock_no;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       /* txt_lock_no = (TextView) findViewById(R.id.txt_lock_no);
        ...
        et_facilityID = (EditText) findViewById(R.id.et_facilityID);

        text_carParking_address = (TextView) findViewById(R.id.text_carParking_address);

        btn_location = (ImageButton) findViewById(R.id.btn_location);

        et_carParking_address = (EditText) findViewById(R.id.et_carParking_address);
...
*/
    ...
    /*public void saveCarParkingList() {
        SharedPreferences.Editor editor = getApplicationContext()
                .getSharedPreferences(RegisterParkingActivity.class.getName(), Context.MODE_PRIVATE).edit();
    ...
    private void readSavedCarParkingList() {
        ...
        SharedPreferences preferences = getApplicationContext()
                .getSharedPreferences(RegisterParkingActivity.class.getName(), Context.MODE_PRIVATE);
